<template>
  ...
  <section>
    <h3 class="section-title">Éditeur du site</h3>
    <p>Vous êtes sur le site Internet : <a href="https://www.borreze.com" class="link">https://www.borreze.com</a></p>
    <p>Le site « borreze.com » ainsi que tous ses composants sont la propriété de la commune de Borrèze.</p><br>
    <p>Commune de Borrèze</p>
    <p>Adresse : Mairie de Borrèze, Le Bourg, 24590 Borrèze </p>
    <p>Téléphone : <a class="link" href="tel:+33553288338">05 53 28 83 38</a></p>
    <p>Email : <a class="link" href="mailto:mairie.borreze@wanadoo.fr">mairie.borreze@wanadoo.fr</a></p>
  </section>

  <section>
    <h3 class="section-title">Responsabilités</h3>
    <p>La Commune de Borrèze s'efforce de fournir des informations exactes et à jour sur son site, mais ne peut garantir
      l'exactitude et l'exhaustivité des informations fournies.</p>
    <p>En cas d'erreur ou d'omission, veuillez nous contacter pour rectification.</p>
  ...
  <section>
    <h3 class="section-title">Collecte de données personnelles</h3>
    <p>Le site de la Commune de Borrèze ne collecte aucune donnée personnelle, ne dispose d'aucun formulaire de collecte,
      et ne fait usage d'aucun cookie de suivi.</p>
  </section>

  <section>
    <h3 class="section-title">Loi informatique, fichiers et libertés et protection des données personnelles</h3>
    <p>Les utilisateurs du site sont tenus de respecter les dispositions de la loi informatique, fichiers et libertés,
      dont
  ...
  <section>
    <h3 class="section-title">Propriété intellectuelle et droit d'auteur</h3>
    <p>Le contenu de ce site relève de la législation française et internationale sur le droit d'auteur et la propriété
      intellectuelle.</p>
  ...
  <section>
    <p>Date de dernière mise à jour : 25 décembre 2023</p>
  </section>
</template>
